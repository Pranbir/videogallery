<div id="sidebar" style="background: #000a21 !important;" class="<?php if(is_video() || is_picture() || is_com('conversation')) {echo 'hide';} ?> animated zoomInLeft"> 
...
/* start my playlists */	
?>
<h4 class="li-heading"><?php echo _lang('Others'); ?></h4>
<div class="sidebar-nav blc"><ul>
<?php 
echo '<li style="display:none;"><a href="'.site_url().me.'/?sk=likes"><span class="iconed"><i class="material-icons">&#xE8DC;</i></span> '. _lang('Likes').'</a> </li>
